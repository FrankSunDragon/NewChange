...
#pragma mark - AES加密
//将string转成带密码的data
+(NSString*)encryptAESData:(NSString*)string secretKey:(NSString *)key
{
    key = [ConvertKey getKeyWithKey:key];
...
#pragma mark - AES解密
//将带密码的data转成string
+(NSString*)decryptAESData:(NSString *)string secretKey:(NSString *)key
{
    key = [ConvertKey getKeyWithKey:key];
